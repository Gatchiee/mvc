...
function confirmSubmit(){
	...
	if(check)
		alert("Information is now updated! Go to Display Employees to see changes.");
		}
</script>
<div id="wrapper">
	<div id="header">
	...
	<div id="content">	
		...
		<form action="" method="post">
				...
				<p>Employee ID<br />
					<input type="text" value="<?php echo $_GET['id'];?>" name="empID" readonly="readonly" /></p><br />
				<p>Employee Name<br />
					<input type="text" value="<?php echo $_GET['name'];?>" name="empName" required /></p><br />
				<p>Employee Age<br />
			...
			<p>
				<input type="submit" value="Update" onclick="confirmSubmit();"/>
